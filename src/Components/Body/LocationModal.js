...
export default function LocationModal() {
  ...
  return (
    <div className="md:w-[40rem] lg:w-[40rem] md:h-[9rem] lg:h-[9rem] w-[20rem] h-[24rem] bg-slate-300 rounded-lg mb-3 p-2  flex flex-col">
      ...
      <div className="md:h-[6rem] lg:h-[6rem] w-full h-full p-1 flex lg:flex-row md:flex-row flex-col ">
