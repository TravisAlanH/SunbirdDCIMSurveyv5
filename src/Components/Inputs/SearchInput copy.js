...
export default function SearchInput({ modalBlock, ItemKey }) {
  ...
  const RacksData = useSelector((state) => state.location.DataRacks);
  const AssetsData = useSelector((state) => state.location.DataAssets);
  const Data = modalBlock === "Racks" ? RacksData : AssetsData;
